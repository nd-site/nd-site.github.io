window.quizData = {
    ...
    "questions": [
        ...
        {
            "type": "truefalse",
            "question": "Xét nhận định sau: Hành vi nào sau đây thể hiện 'Văn hóa giao thông' của học sinh?. Các phát biểu dưới đây đúng hay sai?",
            "options": [
        ...
        {
            "type": "truefalse",
            "question": "Xét nhận định sau: Câu nào giải thích đúng về 'Hành vi có thể nhận biết được' trong các dấu hiệu vi phạm?. Các phát biểu dưới đây đúng hay sai?",
            "options": [
        ...
        {
            "type": "truefalse",
            "question": "Xét nhận định sau: Việc học sinh nhắc nhở người thân đội mũ bảo hiểm khi đi xe máy có ý nghĩa gì?. Các phát biểu dưới đây đúng hay sai?",
            "options": [
        ...
        {
            "type": "truefalse",
            "question": "Xét nhận định sau: Theo bài học, tại sao cần phải phối hợp với các lực lượng chức năng?. Các phát biểu dưới đây đúng hay sai?",
            "options": [
    ...
    "title": "gdqp / 10 / on-tap-hk1-2526-v1",
    "examInfo": {

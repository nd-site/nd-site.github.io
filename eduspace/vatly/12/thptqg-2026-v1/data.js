    ...
    "questions": [
        {
            ...
            "correct": 2,
            "explanation": "Nhiệt dung riêng $c$ được định nghĩa từ công thức $Q = mcDelta T$, suy ra $c = Q/(mDelta T)$, đơn vị là J/(kg.K)."
        },
        {
            "type": "multiple",
        ...
        },
        {
            ...
            "options": [
                "Lực phân tử chỉ là lực hút.",
                "Lực phân tử bao gồm cả lực hút và lực đẩy.",
                "Lực phân tử có tác dụng đáng kể khi các phân tử ở gần nhau.",
                "Lực phân tử giữ cho các phân tử không rời xa nhau quá."
            ],
            "correct": 0,
        ...
        },
        {
            ...
            "options": [
                ...
                "Chỉ xảy ra trên bề mặt chất lỏng.",
                "Bao gồm sự bay hơi và sự sôi.",
                "Không cần cung cấp nhiệt lượng."
            ],
            "correct": 2,
        ...
        },
        {
            ...
            "options": [
                "tỉ số giữa khối lượng riêng hơi nước và khối lượng riêng không khí.",
                "tỉ số giữa áp suất riêng phần của hơi nước và áp suất hơi nước bão hòa ở cùng nhiệt độ.",
                "lượng hơi nước có trong 1m3 không khí.",
                "áp suất của hơi nước trong không khí."
            ],
            "correct": 1,
        ...
        },
        {
            ...
            "options": [
                "với vận tốc bất kì.",
                "với vận tốc không vượt quá tốc độ ánh sáng.",
                "với vận tốc tỉ lệ thuận với thời gian.",
                "luôn luôn thẳng đều."
            ],
            "correct": 1,
        ...
        },
        {
            ...
            "correct": "167.2",
            "explanation": "$Q = mcDelta t = 0.5 cdot 4180 cdot (100 - 20) = 167200 J = 167.2 kJ$."
        },
        {
            "type": "short",
        ...
        },
        {
            ...
            "correct": "600",
            "explanation": "$A = pDelta V = 2.10^5 cdot (5-2) cdot 10^{-3} = 2.10^5 cdot 3.10^{-3} = 600 J$."
        },
        {
            "type": "short",

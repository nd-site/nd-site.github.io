window.quizData = {
    ...
    "questions": [
        ...
        },
        {
            ...
            "options": [
                "Green living only means recycling plastic bottles.",
        ...
        },
        {
            ...
            "options": [
                "Cultural diversity can lead to innovation and creativity.",
                "In a multicultural society, people should only follow their own traditions.",
        ...
        {
            "type": "truefalse",
            "question": "About Mass Media:",
            "options": [
                "Mass media includes television, radio, and social media platforms.",
                "Fake news is a serious problem on the internet nowadays.",
        ...
        },
        {
            ...
            "options": [
                "Heritage can be both tangible (buildings) and intangible (festivals).",
                "UNESCO is an international organization that protects world heritage.",
        ...
        },
        {
            ...
            "correct": "inspiring",
            "explanation": "Inspiring: truyền cảm hứng (adj)."
        },
        {
            "type": "short",
            "question": "Supply the correct form of the verb in brackets: 'I (READ) ______ this book since yesterday morning.'",
            "correct": "have been reading",
            "explanation": "Present perfect continuous for an action that started in the past and is still going on."
        },
        {
            "type": "short",
            "question": "Identify the error and correct it: 'She suggested to go to the museum this weekend.' (Write the correct form to replace 'to go')",
            "correct": "going",
            "explanation": "Suggest + V-ing: gợi ý làm gì."
        },
        {
            "type": "short",
            "question": "Rewrite the sentence using 'Having + V3/ed': 'After he had finished the work, he went home.' -> '______ the work, he went home.'",
            "correct": "Having finished",
            "explanation": "Perfect participle for an action that happened before another action."
        },
        {
            "type": "short",
            "question": "What is the synonym of 'preserve' starting with 'c'? (8 letters)",
            "correct": "conserve",
            "explanation": "Conserve: bảo tồn/gìn giữ."
        },
        {
            "type": "short",
            "question": "Fill in the blank with one suitable preposition: 'He is famous ______ his great contributions to science.'",
            "correct": "for",

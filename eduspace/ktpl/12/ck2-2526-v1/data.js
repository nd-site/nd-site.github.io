window.quizData = {
    ...
    "questions": [
        ...
        {
            "type": "truefalse",
            "question": "Xét nhận định sau: Hành vi nào sau đây bị NGHIÊM CẤM theo Luật Bảo vệ môi trường?. Các phát biểu dưới đây đúng hay sai?",
            "options": [
        ...
        {
            "type": "truefalse",
            "question": "Xét nhận định sau: Hoạt động 'Đánh giá tác động môi trường (ĐTM)' được thực hiện khi nào?. Các phát biểu dưới đây đúng hay sai?",
            "options": [
        ...
        {
            "type": "truefalse",
            "question": "Xét nhận định sau: Để giảm thiểu rác thải nhựa, pháp luật khuyến khích công dân thực hiện hành động nào?. Các phát biểu dưới đây đúng hay sai?",
            "options": [
        ...
        {
            "type": "truefalse",
            "question": "Xét nhận định sau: Bảo vệ Tổ quốc Việt Nam xã hội chủ nghĩa là sự nghiệp của ai?. Các phát biểu dưới đây đúng hay sai?",
            "options": [
                "Của riêng Quân đội nhân dân",
                "Của riêng Công an nhân dân",
                "Của toàn dân",

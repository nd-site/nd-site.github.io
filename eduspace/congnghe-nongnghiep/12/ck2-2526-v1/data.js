window.quizData = {
    ...
    "questions": [
        ...
        },
        {
            ...
            "options": [
                "pH = 4 - 5 (môi trường axit mạnh)",
                "pH = 6.5 - 8.5 (môi trường trung tính đến hơi kiềm)",
                "pH = 9 - 10 (môi trường kiềm mạnh)",
                "pH = 1 - 3"
            ],
            "correct": 1,
        ...
        },
        {
            ...
            "options": [
                "Ướp muối",
                "Sấy khô ngay trên tàu",
                "Ướp đá lạnh hoặc cấp đông",
                "Hun khói"
            ],
            "correct": 2,
        ...
        {
            "type": "truefalse",
            "question": "Xét nhận định sau: Sản xuất nước mắm truyền thống là quá trình gì?. Các phát biểu dưới đây đúng hay sai?",
            "options": [
                "Lên men rượu từ cá",
        ...
        {
            "type": "truefalse",
            "question": "Xét nhận định sau: Mục đích của việc ứng dụng công nghệ lạnh đông IQF (Individual Quick Freezing - Cấp đông siêu tốc từng cá thể) trong chế biến tôm xuất khẩu là gì?. Các phát biểu dưới đây đúng hay sai?",
            "options": [
        ...
        {
            "type": "truefalse",
            "question": "Xét nhận định sau: Nguồn lợi thủy sản ở Việt Nam đang đối mặt với nguy cơ suy giảm nghiêm trọng chủ yếu do nguyên nhân nào?. Các phát biểu dưới đây đúng hay sai?",
            "options": [
        ...
        {
            "type": "truefalse",
            "question": "Xét nhận định sau: Hành vi nào sau đây bị nghiêm cấm trong Luật Thủy sản?. Các phát biểu dưới đây đúng hay sai?",
            "options": [

    ...
    "questions": [
        {
            ...
            "options": [
                ...
                "Sự có mặt của các electron tự do trong mạng tinh thể",
        ...
        },
        {
            ...
            "options": [
                "Hoạt động mạnh như Na, K",
                "Có tính khử trung bình và yếu như Cu, Ag",
                "Hoạt động mạnh như Al",
                "Kiềm thổ như Ca, Ba"
            ],
            "correct": 1,
        ...
        },
        {
            ...
            "options": [
                ...
                "Tính oxi hóa của ion kim loại giảm dần",
                "Không có quy luật"
            ],
            "correct": 0,
        ...
        {
            "type": "truefalse",
            "question": "Xét nhận định sau: Hợp chất nào sau đây được dùng để làm mềm nước cứng vĩnh cửu?. Các phát biểu dưới đây đúng hay sai?",
            "options": [
                "Ca(OH)2",
                "HCl",
                "Na2CO3",
        ...
        {
            "type": "truefalse",
            "question": "Xét nhận định sau: Trong công nghiệp, nhôm (Al) được điều chế bằng phương pháp nào?. Các phát biểu dưới đây đúng hay sai?",
            "options": [
                "Điện phân Al2O3 nóng chảy",
                "Điện phân dung dịch AlCl3",
                "Nhiệt luyện từ Al2O3",
                "Thủy luyện"
            ],
            "correct": [
                true,
        ...
        {
            "type": "truefalse",
            "question": "Xét nhận định sau: Nhôm không phản ứng với dung dịch nào sau đây?. Các phát biểu dưới đây đúng hay sai?",
            "options": [
                "NaOH",
                "HCl",
                "H2SO4 đặc, nguội",
        ...
        {
            "type": "truefalse",
            "question": "Xét nhận định sau: Để bảo quản kim loại natri, người ta phải ngâm natri trong:. Các phát biểu dưới đây đúng hay sai?",
            "options": [
                "Nước",
                "Dầu hỏa",
                "Cồn",
        ...
        {
            "type": "short",
            "question": "Hiện tượng thạch nhũ trong các hang động núi đá vôi là kết quả của phản ứng: (Lưu ý: Đáp án đúng gốc là \"Ca(HCO3)2 -> CaCO3 + CO2 + H2O\". Hãy nhập số hoặc giá trị thích hợp)",
            "correct": "Ca(HCO3)2 -> CaCO3 + CO2 + H2O",
            "explanation": "Thạch nhũ được tạo thành do sự phân hủy chậm của Ca(HCO3)2 tạo ra CaCO3 kết tủa."
        },
        {
            "type": "short",
            "question": "Chất nào sau đây có tính lưỡng tính? (Lưu ý: Đáp án đúng gốc là \"Al2O3\". Hãy nhập số hoặc giá trị thích hợp)",
            "correct": "Al2O3",
            "explanation": "Al2O3 và Al(OH)3 là các chất lưỡng tính, vừa tác dụng với axit vừa tác dụng với bazơ."
        },
        {
            "type": "short",
            "question": "Cấu hình electron của nguyên tử Fe (Z=26) là: (Lưu ý: Đáp án đúng gốc là \"[Ar]3d6 4s2\". Hãy nhập số hoặc giá trị thích hợp)",
            "correct": "[Ar]3d6 4s2",
            "explanation": "Cấu hình của Fe là 1s2 2s2 2p6 3s2 3p6 3d6 4s2, viết gọn là [Ar]3d6 4s2."
        },
        {
            "type": "short",
            "question": "Hợp chất sắt (II) có tính chất hóa học đặc trưng là: (Lưu ý: Đáp án đúng gốc là \"Vừa có tính oxi hóa, vừa có tính khử\". Hãy nhập số hoặc giá trị thích hợp)",
            "correct": "Vừa có tính oxi hóa, vừa có tính khử",

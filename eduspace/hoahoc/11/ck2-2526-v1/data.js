window.quizData = {
    ...
    "questions": [
        ...
        },
        {
            ...
            "options": [
                "-OH liên kết trực tiếp với nguyên tử carbon no",
                "-OH liên kết trực tiếp với nguyên tử carbon vòng benzene",
                "-CHO",
                "-COOH"
            ],
            "correct": 0,
        ...
        },
        {
            ...
            "options": [
                ...
                "Có kết tủa vàng",
                "Có khí thoát ra",
                "Dung dịch mất màu đỏ nâu, không kết tủa"
            ],
            "correct": 0,
        ...
        },
        {
            ...
            "options": [
                "Ethanol có liên kết ion",
                "Ethanol có liên kết hydrogen liên phân tử",
                "Ethanol có khối lượng riêng lớn hơn",
                "Ethanol có nhiều carbon hơn"
            ],
            "correct": 1,
        ...
        {
            "type": "truefalse",
            "question": "Xét nhận định sau: Để nhận biết aldehyde, người ta thường dùng thuốc thử nào sau đây?. Các phát biểu dưới đây đúng hay sai?",
            "options": [
                "Dung dịch AgNO3/NH3",
                "Quỳ tím",
                "Nước bromine",
        ...
        {
            "type": "truefalse",
            "question": "Xét nhận định sau: Phản ứng cộng H2 vào CH3CHO (xúc tác Ni, to) thu được sản phẩm là:. Các phát biểu dưới đây đúng hay sai?",
            "options": [
                "CH3CH2OH",
                "CH3COOH",
                "CH3CH3",
        ...
        {
            "type": "truefalse",
            "question": "Xét nhận định sau: Formaldehyde (HCHO) được ứng dụng phổ biến để:. Các phát biểu dưới đây đúng hay sai?",
            "options": [
                "Làm gia vị thức ăn",
                "Ngâm tiêu bản sinh học (cồn, formalin)",
                "Sản xuất xà phòng",
        ...
        {
            "type": "truefalse",
            "question": "Xét nhận định sau: Acetone (CH3COCH3) không có phản ứng nào sau đây?. Các phát biểu dưới đây đúng hay sai?",
            "options": [
                "Phản ứng cộng H2",
                "Phản ứng tráng bạc",
                "Phản ứng cháy",
        ...
        {
            "type": "short",
            "question": "Hợp chất tạo được kết tủa vàng với I2 trong dung dịch NaOH (phản ứng iodoform) phải có nhóm: (Lưu ý: Đáp án đúng gốc là \"CH3-CO-\". Hãy nhập số hoặc giá trị thích hợp)",
            "correct": "CH3-CO-",
            "explanation": "Phản ứng iodoform đặc trưng cho các hợp chất có nhóm CH3-CO- (methyl ketone) hoặc CH3-CH(OH)-."
        },
        {
            "type": "short",
            "question": "Oxi hóa hoàn toàn một hợp chất carbonyl bằng O2 thu được carboxylic acid có cùng số nguyên tử C. Hợp chất đó là: (Lưu ý: Đáp án đúng gốc là \"Aldehyde\". Hãy nhập số hoặc giá trị thích hợp)",
            "correct": "Aldehyde",
            "explanation": "Aldehyde dễ bị oxi hóa tạo thành carboxylic acid tương ứng (RCHO -> RCOOH)."
        },
        {
            "type": "short",
            "question": "Nhóm chức của carboxylic acid là: (Lưu ý: Đáp án đúng gốc là \"-COOH\". Hãy nhập số hoặc giá trị thích hợp)",
            "correct": "-COOH",
            "explanation": "Nhóm chức đặc trưng là nhóm carboxyl (-COOH)."
        },
        {
            "type": "short",
            "question": "Acetic acid (CH3COOH) là thành phần chính của: (Lưu ý: Đáp án đúng gốc là \"Giấm ăn\". Hãy nhập số hoặc giá trị thích hợp)",
            "correct": "Giấm ăn",

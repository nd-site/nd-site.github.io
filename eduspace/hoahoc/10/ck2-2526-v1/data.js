window.quizData = {
    ...
    "examInfo": {
        ...
        "school": "",
        "province": "",
        "examName": "Kiểm tra Cuối Học Kì II",
        "attempt": "Bản 1",
    ...
    "questions": [
        ...
        },
        {
            ...
            "options": [
                "Dạng đơn chất",
                "Trong các khoáng vật như fluorite (CaF2)",
        ...
        },
        {
            ...
            "options": [
                "Chất rắn chuyển sang chất lỏng",
                "Chất rắn chuyển thẳng sang chất khí",
                "Chất khí chuyển sang chất lỏng",
                "Chất lỏng chuyển sang chất khí"
            ],
            "correct": 1,
        ...
        {
            "type": "truefalse",
            "question": "Xét nhận định sau: Enthalpy tạo thành chuẩn (ΔfH°298) của các đơn chất ở dạng bền vững nhất bằng:. Các phát biểu dưới đây đúng hay sai?",
            "options": [
                "0",
                "1",
                "< 0",
        ...
        {
            "type": "truefalse",
            "question": "Xét nhận định sau: Đại lượng đặc trưng cho nhiệt lượng trao đổi của một phản ứng hóa học ở áp suất không đổi gọi là:. Các phát biểu dưới đây đúng hay sai?",
            "options": [
                "Nhiệt độ",
                "Nhiệt dung",
                "Biến thiên enthalpy",
        ...
        {
            "type": "truefalse",
            "question": "Xét nhận định sau: Cho phản ứng: C(s) + O2(g) -> CO2(g) có ΔrH°298 = -393,5 kJ. Phát biểu nào đúng?. Các phát biểu dưới đây đúng hay sai?",
            "options": [
                "Phản ứng thu nhiệt",
                "Đốt cháy 1 mol C(s) tỏa ra nhiệt lượng 393,5 kJ",
                "Sự hình thành 1 mol CO2 cần 393,5 kJ",
        ...
        {
            "type": "truefalse",
            "question": "Xét nhận định sau: Cho phương trình nhiệt hóa học: N2(g) + O2(g) -> 2NO(g) ; ΔrH°298 = +180,6 kJ. Phát biểu nào sau đây đúng?. Các phát biểu dưới đây đúng hay sai?",
            "options": [
                "Phản ứng tỏa nhiệt",
                "Nhiệt tạo thành của NO là +180,6 kJ/mol",
                "Phản ứng thu nhiệt",
                "Nhiệt tạo thành của N2 là 180,6 kJ/mol"
            ],
            "correct": [
                false,
                false,
        ...
        {
            "type": "short",
            "question": "Khi biết năng lượng liên kết, ta có thể tính biến thiên enthalpy của phản ứng bằng công thức: (Lưu ý: Đáp án đúng gốc là \"Tổng năng lượng liên kết chất đầu - Tổng năng lượng liên kết sản phẩm\". Hãy nhập số hoặc giá trị thích hợp)",
            "correct": "Tổng năng lượng liên kết chất đầu - Tổng năng lượng liên kết sản phẩm",
            "explanation": "ΔrH = ∑Eb(chất đầu) - ∑Eb(sản phẩm)."
        },
        {
            "type": "short",
            "question": "Điều kiện chuẩn là: (Lưu ý: Đáp án đúng gốc là \"Áp suất 1 bar, nồng độ 1 mol/L, nhiệt độ thường là 25°C (298K)\". Hãy nhập số hoặc giá trị thích hợp)",
            "correct": "Áp suất 1 bar, nồng độ 1 mol/L, nhiệt độ thường là 25°C (298K)",
            "explanation": "Điều kiện chuẩn theo quy ước hiện hành: P = 1 bar, nhiệt độ 25°C (298,15K)."
        },
        {
            "type": "short",
            "question": "Phản ứng đốt cháy cồn (ethanol) là phản ứng: (Lưu ý: Đáp án đúng gốc là \"Tỏa nhiệt\". Hãy nhập số hoặc giá trị thích hợp)",
            "correct": "Tỏa nhiệt",
            "explanation": "Phản ứng đốt cháy luôn là phản ứng tỏa nhiệt mạnh."
        },
        {
            "type": "short",
            "question": "Tốc độ phản ứng đặc trưng cho: (Lưu ý: Đáp án đúng gốc là \"Sự thay đổi nồng độ chất phản ứng hoặc sản phẩm trong một đơn vị thời gian\". Hãy nhập số hoặc giá trị thích hợp)",
            "correct": "Sự thay đổi nồng độ chất phản ứng hoặc sản phẩm trong một đơn vị thời gian",

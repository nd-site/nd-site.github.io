window.quizData = {
    ...
    "questions": [
        ...
        {
            "type": "multiple",
            "question": "Thực vật C4 (như ngô, mía) có ưu điểm gì so với thực vật C3?",
            "options": [
                "Cần ít ánh sáng hơn.",
                "Có điểm bù $CO_2$ thấp hơn, năng suất quang hợp cao hơn.",
                "Chỉ quang hợp được vào ban đêm.",
                "Thích nghi tốt với khí hậu ôn đới lạnh."
            ],
            "correct": 1,
            "explanation": "Thực vật C4 có cơ chế tập trung $CO_2$ giúp giảm tối đa quá trình hô hấp sáng."
        },
        {
            "type": "multiple",
        ...
        {
            "type": "multiple",
            "question": "Hiện tượng thoát hơi nước ở lá thực vật có vai trò gì quan trọng nhất?",
            "options": [
                "Làm ấm lá khi trời lạnh.",
                "Tạo động lực đầu trên cho dòng mạch gỗ, giúp vận chuyển nước và khoáng.",
                "Giúp cây hô hấp tốt hơn.",
                "Cung cấp năng lượng cho cây."
            ],
            "correct": 1,
            "explanation": "Thoát hơi nước tạo sức hút kéo cột nước từ rễ lên lá."
        },
        {
            "type": "multiple",
            "question": "Hệ tuần hoàn hở có đặc điểm nào sau đây?",
            "options": [
                "Máu luôn chảy trong mạch kín.",
                "Máu chảy trong động mạch với áp lực rất cao.",
                "Có sự tiếp xúc trực tiếp giữa máu và tế bào cơ thể tại khoang cơ thể.",
                "Máu không chứa sắc tố hô hấp."
            ],
            "correct": 2,
        ...
        },
        {
            ...
            "options": [
                "Thực vật hấp thụ nitơ chủ yếu dưới dạng phân tử $N_2$ trong không khí qua lá.",
                "Pha tối của quang hợp diễn ra tại chất nền (stroma) của lục lạp.",
        ...
        {
            "type": "truefalse",
            "question": "Về hệ tiêu hóa ở động vật:",
            "options": [
                "Ở động vật ăn cỏ (như bò), dạ dày có 4 ngăn để thích nghi với việc tiêu hóa xenlulozo.",
                "Ruột non là nơi diễn ra sự tiêu hóa hóa học và hấp thụ chất dinh dưỡng mạnh nhất.",
        ...
        {
            "type": "truefalse",
            "question": "Về hệ tuần hoàn và hô hấp ở động vật:",
            "options": [
                "Ở cá, máu đi nuôi cơ thể là máu giàu $O_2$.",
                "Chim có hệ hô hấp hiệu quả nhất trong các động vật trên cạn nhờ hệ thống túi khí.",
        ...
        {
            "type": "truefalse",
            "question": "Về cân bằng nội môi:",
            "options": [
                "Thận và gan đóng vai trò quan trọng trong việc ổn định áp suất thẩm thấu của máu.",
                "Khi nồng độ Glucose trong máu tăng cao, tuyến tụy sẽ tiết ra Glucagon để làm giảm đường huyết.",
        ...
        },
        {
            ...
            "correct": "C6H12O6 + O2",
            "explanation": "6CO2 + 6H2O --(as, dl)--> C6H12O6 + 6O2."
        },
        {
            "type": "short",
            "question": "Bào quan nào thực hiện chức năng quang hợp ở cây xanh?",
            "correct": "Luc lap",
            "explanation": "Lục lạp (Chloroplast)."
        },
        {
            "type": "short",
            "question": "Động vật nào có hệ tuần hoàn chỉ gồm 1 vòng tuần hoàn và tim có 2 ngăn?",
            "correct": "Ca",
            "explanation": "Các loài cá xương, cá sụn."
        },
        {
            "type": "short",
            "question": "Tính nhịp tim (lần/phút) của một người bình thường nếu một chu kì tim kéo dài 0,8 giây.",
            "correct": "75",
            "explanation": "60 / 0,8 = 75 lần/phút."
        },
        {
            "type": "short",
            "question": "Chất khí nào là sản phẩm thải ra của quá trình hô hấp tế bào?",
            "correct": "CO2",
            "explanation": "Carbon dioxide."
        },
        {
            "type": "short",
            "question": "Hệ đệm quan trọng nhất trong máu giúp duy trì pH là hệ đệm gì? (Viết tắt công thức phân tử của muối bicarbonate)",
            "correct": "NaHCO3",

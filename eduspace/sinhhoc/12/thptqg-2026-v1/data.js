    ...
    "questions": [
        ...
        },
        {
            ...
            "options": [
                ...
                "Bộ ba nào cũng mã hóa cho axit amin.",
        ...
        },
        {
            ...
            "options": [
                "Cơ quan tương đồng",
                "Cơ quan thoái hóa",
                "Sự tương đồng về trình tự nucleotit trong ADN",
                "Hóa thạch"
            ],
            "correct": 2,
        ...
        },
        {
            ...
            "options": [
                "Có cùng nguồn gốc, đảm nhiệm những chức năng giống nhau.",
                "Có cùng nguồn gốc, có thể đảm nhiệm những chức năng khác nhau.",
                "Có nguồn gốc khác nhau, đảm nhiệm những chức năng giống nhau.",
                "Có nguồn gốc khác nhau, đảm nhiệm những chức năng khác nhau."
            ],
            "correct": 1,
        ...
        },
        {
            ...
            "options": [
                "Môi trường -> SV sản xuất -> SV tiêu thụ -> SV phân giải -> Môi trường.",
                "SV tiêu thụ -> SV sản xuất -> Môi trường.",
                "SV phân giải -> SV tiêu thụ -> SV sản xuất.",
                "Môi trường -> SV phân giải -> SV tiêu thụ."
            ],
            "correct": 0,
        ...
        },
        {
            ...
            "options": [
                "Tạo ADN tái tổ hợp -> Đưa ADN tái tổ hợp vào tế bào nhận -> Phân lập gen.",
                "Phân lập gen -> Tạo ADN tái tổ hợp -> Đưa ADN tái tổ hợp vào tế bào nhận -> Phân lập dòng tế bào chứa ADN tái tổ hợp.",
                "Đưa ADN tái tổ hợp vào tế bào nhận -> Tạo ADN tái tổ hợp.",
                "Tạo ADN tái tổ hợp -> Phân lập gen."
            ],
            "correct": 1,
